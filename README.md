...
To reproduce, compile main.cpp, linking against the Xarm C++ API, and making sure the Eigen library is available on the system. Then run the program, which will wait for user input.  
